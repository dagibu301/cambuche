    ...
    return(
      <div>
        <div className="row mt-5">
          ...
          <div className="col-md-4 mr-lg-5 ml-lg-5">
            <h2 className="yellow-tittle">HOSPEDAJE</h2>
          </div>

          <div className="col-md-2 ml-2"  id="bg-2-lines">
          </div>

        </div>
        <div className="row mt-5 justify-content-around">

          <div className="col-sm-12  col-lg-6 col-xl-4 mt-4">
          ...
          <div className="col-12 col-lg-6 col-sm-12 col-xl-4 mt-4 ">
